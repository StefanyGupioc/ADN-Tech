...
t1 = Tutor.new("73177968", "Sarria", "Juan Alberto", "NN")
t2 = Tutor.new("73177964", "Gonsales", "Luis Mario", "NN")

alNacional1 = Nacional.new("00000001", "Alzamora", "Fiorella", 20, "F", "SMP", 11)
alNacional2 = Nacional.new("00000002", "Gorriti", "Priscila", 26, "F", "SMP", 10)
alNacional3 = Nacional.new("00000003", "Brito", "Kimberling", 24, "F", "SJL", 15)

alParticular4 = Particular.new("00000004", "Benavides", "Josue", 30, "M", 200, 1)
alParticular5 = Particular.new("00000005", "Brito", "Michael", 26, "M", 400, 2)
alParticular6 = Particular.new("00000006", "Hinostroza", "Juan", 24, "M", 500, 3)
